describe("Importation d'étudiants", () => {
    it("Redirige vers Casdoor, se connecte avec un compte manager et arrive sur le dashboard", () => {
        ...
        cy.get('input[id="ref"]').type("ETD004_groupe14");
        cy.get('input[id="first_name"]').type("kareemmm_groupe14");
        cy.get('input[id="last_name"]').type("Nomenjanaharyyyyyyyy_groupe14");
        cy.get('input[id="sex_M"]').click();
        cy.get('input[id="phone"]').type("0345368840");
        cy.get('input[id="coordinates.latitude"]').type("1");
        cy.get('input[id="coordinates.longitude"]').type("1");
        cy.get('input[id="nic"]').type("126456789123");
        ...
        cy.get('input[id="email"]').type("hei.nomna.2@gmail.com");
